...
internal object RegisterTreeCopyHandlerUtils {
  fun register() {
    // Adapted from https://github.com/detekt/detekt/blob/2679bd2154f29ba6a2944a7f202426ad819485a9/detekt-parser/src/main/kotlin/io/github/detekt/parser/DetektPomModel.kt#L23-L40
    val extensionArea = Extensions.getRootArea()
    if (!extensionArea.hasExtensionPoint(EXTENSION_PATH)) {
