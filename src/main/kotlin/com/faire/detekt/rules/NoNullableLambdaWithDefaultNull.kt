...
internal class NoNullableLambdaWithDefaultNull(config: Config = Config.empty) : Rule(config, "Instead of using nullable callbacks with default value of null, use non-nullable callbacks with a default empty lambda.") {
